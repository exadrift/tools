<img width="1022" height="1023" alt="crucible" src="https://github.com/user-attachments/assets/ce33a19b-67b7-47cb-a9de-59f04fefca7e" />
<b>provision local and remote environments with a single binary (no dependencies)</b>
<br/><br/>
...
```
curl https://raw.githubusercontent.com/exadrift/tools/refs/heads/main/install.sh | sudo sh -s -- crucible v0
```
once downloaded, run `crucible --help`

check out the [example](https://github.com/exadrift/crucible/blob/main/testcontainer/end-to-end) recipe for in-depth coverage of use cases.
...
here's an [example](https://github.com/exadrift/tools/crucible/blob/main/testcontainer/end-to-end/sequences/end-to-end-test.yaml) sequence file, which is currently being used in the end-to-end test.
...
crucible publish docker.io/exadrift
```

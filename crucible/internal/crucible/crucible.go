...
import (
	...
	"github.com/exadrift/tools/crucible/internal/executor"
	"github.com/exadrift/tools/crucible/internal/log"
	"github.com/exadrift/tools/crucible/internal/oci"
...
func executeSequence(recipe *Recipe, cwdPath string, configPaths []string, valuesPaths []string, sequencePath string, targets []string, debug bool, jsonOutput bool) ([]byte, error) {
	...
	valuesStore, err := kv.FromMapping(recipe.Values)
	if err != nil {
		return nil, err
	}

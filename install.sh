...
echo "downloading ${RELEASE_NAME} version ${LATEST_VERSION}"
curl -L https://github.com/exadrift/tools/releases/download/${RELEASE_NAME}-${LATEST_VERSION}/${RELEASE_NAME}-${OS}-${ARCH} -o ${TARGET_PATH}
chmod +x ${TARGET_PATH}
